...
RSpec.describe "Mobile-First Tailwind Breakpoints", type: :request do
  ...
  describe "GET /tasks/new" do
    it "renders wrapper com mobile-first (w-full) e max-width para desktop (sm:max-w-[1536px])" do
      get new_task_path
      expect(response).to have_http_status(:ok)
  ...
  describe "GET /tasks/:id/edit" do
    ...
    it "renders wrapper com mobile-first (w-full sm:max-w-[1536px] sm:mx-auto)" do
